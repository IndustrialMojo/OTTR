...
'Tigersharks',
(SELECT DISTINCT a.ID FROM ebdb.NTT_LOCATION a, ebdb.NTT_CITY_STATE b WHERE a.CITY_STATE_ID = b.ID AND b.CITY = 'Farmington'),
(SELECT DISTINCT a.ID FROM ebdb.USR_USER a LIMIT 1),
(SELECT DISTINCT a.ID FROM ebdb.USR_USER a LIMIT 1));
...
'Otters Swim Team',
'Otters',
(SELECT DISTINCT a.ID FROM ebdb.NTT_LOCATION a, ebdb.NTT_CITY_STATE b WHERE a.CITY_STATE_ID = b.ID AND b.CITY = 'Minneapolis'),
(SELECT DISTINCT a.ID FROM ebdb.USR_USER a LIMIT 1),
(SELECT DISTINCT a.ID FROM ebdb.USR_USER a LIMIT 1));
...
'STAR Swim Team',
'',
(SELECT DISTINCT a.ID FROM ebdb.NTT_LOCATION a, ebdb.NTT_CITY_STATE b WHERE a.CITY_STATE_ID = b.ID AND b.CITY = 'Saint Paul'),
(SELECT DISTINCT a.ID FROM ebdb.USR_USER a LIMIT 1),
(SELECT DISTINCT a.ID FROM ebdb.USR_USER a LIMIT 1));
...
'Sharks',
(SELECT DISTINCT a.ID FROM ebdb.NTT_LOCATION a, ebdb.NTT_CITY_STATE b WHERE a.CITY_STATE_ID = b.ID AND b.CITY = 'Hudson'),
(SELECT DISTINCT a.ID FROM ebdb.USR_USER a LIMIT 1),
(SELECT DISTINCT a.ID FROM ebdb.USR_USER a LIMIT 1));
...
'Sharks',
(SELECT DISTINCT a.ID FROM ebdb.NTT_LOCATION a, ebdb.NTT_CITY_STATE b WHERE a.CITY_STATE_ID = b.ID AND b.CITY = 'Woodbury'),
(SELECT DISTINCT a.ID FROM ebdb.USR_USER a LIMIT 1),
(SELECT DISTINCT a.ID FROM ebdb.USR_USER a LIMIT 1));
...
'Mako Sharks',
(SELECT DISTINCT a.ID FROM ebdb.NTT_LOCATION a, ebdb.NTT_CITY_STATE b WHERE a.CITY_STATE_ID = b.ID AND b.CITY = 'North Oaks'),
(SELECT DISTINCT a.ID FROM ebdb.USR_USER a LIMIT 1),
(SELECT DISTINCT a.ID FROM ebdb.USR_USER a LIMIT 1));
